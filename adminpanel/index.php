...
<head>
    ...
    <style>
        .kotak {
            border: 1px solid black; /* Anda bisa menyesuaikan border sesuai kebutuhan */
            padding: 10px; /* Opsional, untuk memberi jarak di dalam border */
            margin-top: 20px; /* Opsional, untuk memberi jarak dari elemen di atasnya */
        }
